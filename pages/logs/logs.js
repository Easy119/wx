...
Page({
  ...
  change: function (e) {
    ...
    if (get_move_id == 1 && !this.data.get_index_1) {
      ...
      //  这是 已经安装好桌子腿 后的页面加载
      //  获取 移动这个对象的 目标的src
      // var move_obj_src = get_move_arr[Number(get_move_id - 2)].src;
      // 获取固定 背景的 数据集合
      // var fixed_view_arr = this.data.fixed_view;
      // // 获取三个 高度下的 src
      // var fixed_obj_src_1 = "../../images/product/2.png";
      // var fixed_obj_src_2 = "../../images/product/5.png";
      // var fixed_obj_src_3 = "../../images/product/3.png";
      // var fixed_obj_src_1 = fixed_view_arr[0].src == "../../images/product/2.png" ? "../../images/product/2.png" : fixed_view_arr[0].src;
      // var fixed_obj_src_2 = fixed_view_arr[1].src == "../../images/product/5.png" ? "../../images/product/5.png" : fixed_view_arr[1].src;
      // var fixed_obj_src_3 = fixed_view_arr[2].src == "../../images/product/3.png" ? "../../images/product/3.png" : fixed_view_arr[2].src;
      //   接下来 根据 坐标 开始 判断 
      // if (move_x > base_x && move_x < end_x) {
      //   // 第一个默认 灰色格子 的坐标
      //   if (move_y > base_y && move_y < 450 * get_rate) {
      //     fixed_view_arr[0].src = move_obj_src;
      //     fixed_view_arr[1].src = fixed_obj_src_2;
      //     fixed_view_arr[2].src = fixed_obj_src_3;
      //     this.setData({
      //       fixed_view: fixed_view_arr
      //     });
      //   } else if (move_y > 450 * get_rate && move_y < 600 * get_rate) {
      //     // 第二个默认 灰色格子 的坐标
      //     fixed_view_arr[0].src = fixed_obj_src_1;
      //     fixed_view_arr[1].src = move_obj_src;
      //     fixed_view_arr[2].src = fixed_obj_src_3;
      //     this.setData({
      //       fixed_view: fixed_view_arr
      //     });
      //   } else if (move_y > 600 * get_rate && move_y < 700 * get_rate) {
      //     // 第三个默认 灰色格子 的坐标
      //     fixed_view_arr[0].src = fixed_obj_src_1;
      //     fixed_view_arr[1].src = fixed_obj_src_2;
      //     fixed_view_arr[2].src = move_obj_src;
      //     this.setData({
      //       fixed_view: fixed_view_arr
      //     });
      //   }
    ...
    if (get_move_id == 1 && !this.data.get_index_1) {
      ...
      // var move_obj_src = get_move_arr[Number(now_use_id - 2)].src;
      // 获取固定 背景的 数据集合
      // var fixed_view_arr = this.data.fixed_view;
      // // 获取三个 高度下的 src
      // var fixed_obj_src_1 = fixed_view_arr[0].src;
      // var fixed_obj_src_2 = fixed_view_arr[1].src;
      // var fixed_obj_src_3 = fixed_view_arr[2].src;
      //   接下来 根据 坐标 开始 判断 
      if (move_x > base_x && move_x < end_x) {
        // 第一个默认 灰色格子 的坐标
        if (move_y > base_y && move_y < 400 * get_rate) {
          ...
          // fixed_view_arr[1].src = fixed_obj_src_2;
          // fixed_view_arr[2].src = fixed_obj_src_3;
          // get_move_arr[Number(now_use_id - 2)].flag = true;
          // this.setData({
          //   fixed_view: fixed_view_arr,
          //   move_box_arr: get_move_arr
          // });
          ...
          //   move_box_arr: get_move_arr
          // });
          // console.log(this.data.fixed_view)
        }
        this.setData({
          move_box_arr: get_move_arr
        })
  ...
  // user_cancle: function () {
  //   var get_move_arr = this.data.move_box_arr;
  //   for (var i = 0; i < get_move_arr.length; i++) {
  //     get_move_arr[i].flag = true
  //   };
  //   this.setData({
  //     move_box_arr: get_move_arr
  //   })
