...
Page({
  ...
  get_img: function () {
    ...
    var get_arr = this.data.move_arr;
    var get_img_arr = [];
    console.log(get_img_arr)
    get_img_arr.push({
      src: "../../images/bg/bg_3.png",
      x: 0,
      y: 0,
    },{
      src: "../../images/bg/20.png",
    ...
    for (var i = 0; i < get_img_arr.length; i++) {
      if (get_img_arr[i].src == "../../images/bg/bg_3.png"){
        console.log("ASDF")
        ctx.drawImage(get_img_arr[i].src, get_img_arr[i].x, get_img_arr[i].y, (750 * get_rate), (1206 * get_rate))
      }else{
        console.log("ASDFasdfasdf")
        ctx.drawImage(get_img_arr[i].src, get_img_arr[i].x, get_img_arr[i].y, (350 * get_rate), (150* get_rate))
      }
    }
