...
Page({
        ...
        if (this.data.next_flag) {
          ...
          if (get_move_arr.length < 5) {
            if (get_move_arr.length < 2) {
              if (get_id == "2" || get_id == "5" || get_id == "6" || get_id == "7") {
                wx.showModal({
                  title: '友情提示',
                  content: '柜子不能悬空设置',
                })
  ...
  change: function (e) {
    ...
    if (move_x > 0 * get_rate && move_x < 620 * get_rate) {
      ...
      switch (get_obj_src) {
        case "../../images/bg/17.png": // 这是最上面的玻璃小柜子
          get_move_arr[get_id].x = 50 * get_rate;
          get_move_arr[get_id].y = 200 * get_rate;
          break;
        case "../../images/bg/21.png": // 这是最上面的最右边 
          get_move_arr[get_id].x = 450 * get_rate;
          get_move_arr[get_id].y = 200 * get_rate;
          break;
        case "../../images/bg/22.png": // 这是最上面的最右边 
          get_move_arr[get_id].x = 450 * get_rate;
          get_move_arr[get_id].y = 200 * get_rate;
          break;
        case "../../images/bg/23.png": // 这是最上面的最右边 
          get_move_arr[get_id].x = 450 * get_rate;
